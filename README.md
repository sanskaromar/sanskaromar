...
|[Certifai](https://github.com/sanskaromar/certifai)| Python | Generate bulk custom certificates from template superfast and with ease⚡, Built this for Google Developer Student Club's Community | [here](https://github.com/sanskaromar/certifai) |
...
|Logical Rhythm 2k23 - Kaggle Competitions Host |Natural Language Processing, Basic Classification and Regression based tasks|Hosted Logical Rhythm 2k23 - An annual machine learning event at NIT Allahabad focused on encouraging Data Science and ML culture in college|[Pilot](https://www.kaggle.com/competitions/anyas-gojo-revival), [Detective Bondman](https://www.kaggle.com/competitions/anyas-gojo-revival-bondman), [Space shop](https://www.kaggle.com/competitions/anyas-gojo-revival-space-shop), [The Aerospace Enigma](https://www.kaggle.com/competitions/anyas-gojo-revival-aerospace-enigma)|
